...
2. 仓库名：`yanxizaomu-images`（或你喜欢的名字）
3. 公开仓库（Public）
4. 不要初始化 README
...
```html
<!-- 原始链接 -->
https://raw.githubusercontent.com/your-username/yanxizaomu-images/main/霓虹都市里的蕾塞.png
...
// 配置
const GITHUB_USER = 'your-username'; // 替换为你的 GitHub 用户名
const REPO_NAME = 'yanxizaomu-images';
const BRANCH = 'main';

// 图片映射
const imageMap = {
  '霓虹都市里的蕾塞.png': 'https://cdn.jsdelivr.net/gh/' + GITHUB_USER + '/' + REPO_NAME + '@' + BRANCH + '/霓虹都市里的蕾塞.png',
  '望云少女_铁道道口.jpg': 'https://cdn.jsdelivr.net/gh/' + GITHUB_USER + '/' + REPO_NAME + '@' + BRANCH + '/望云少女_铁道道口.jpg',
  '樱花刀姬_水畔剪影.png': 'https://cdn.jsdelivr.net/gh/' + GITHUB_USER + '/' + REPO_NAME + '@' + BRANCH + '/樱花刀姬_水畔剪影.png',
};
...
for (const file of files) {
  ...
  for (const [oldPath, newUrl] of Object.entries(imageMap)) {
    content = content.replace(
      new RegExp(`["'](/images/${oldPath.replace('.', '\\.')})["']`, 'g'),
      `"${newUrl}"`
    );
  }
